 ...
 * @author: Kevin Liu
 * @see Progression
 * @see ArithProgression
 * @see GeomProgression
 * @see FibonacciProgression
 * @see Difference
 * @see Sum
 * @see MyProgression
 */
...
class TestProgression {
  ...
  public static void main(String[] args) {
    ...
    // my code starts here
    // give 11 values of a Fibonacci Progression that starts with 11 and 16
    ...
    prog.printProgression(10);
    System.out.println("My progression with start values 6:");
    prog = new MyProgression(6);
    prog.printProgression(10);
