...
public class Tester {
  ...
  public static void main(String[] args) {
	...
	CreditCard card2 = new CreditCard("3479 2918 8618 9727", 
		"Kevin Liu", "Geek Bank", 500.0, 3000);
	CreditCard.printCard(card2);
	
	System.out.println("Setting card2's credit limit to 1000...");
	card2.setLimit(1000);
	
	System.out.println("Changing card2's card holder name to Steve Jobs...");
	card2.setName("Steve Jobs");
